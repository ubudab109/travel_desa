...
<div class="form-group row ">
  {!! Form::label('store_id', trans("lang.earning_store_id"),['class' => 'col-3 control-label text-right']) !!}
  <div class="col-9">
    {!! Form::select('store_id', $store, null, ['class' => 'select2 form-control']) !!}
    <div class="form-text text-muted">{{ trans("lang.earning_store_id_help") }}</div>
  </div>
</div>
...
<!-- Store Earning Field -->
<div class="form-group row ">
  {!! Form::label('store_earning', trans("lang.earning_store_earning"), ['class' => 'col-3 control-label text-right']) !!}
  <div class="col-9">
    {!! Form::number('store_earning', null,  ['class' => 'form-control','placeholder'=>  trans("lang.earning_store_earning_placeholder")]) !!}
    <div class="form-text text-muted">
      {{ trans("lang.earning_store_earning_help") }}
    </div>
  </div>
</div>
