...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <div class="form-group row ">
        {!! Form::label('capacity', trans("lang.items_available"), ['class' => 'col-3 control-label text-right']) !!}
        <div class="col-9">
            {!! Form::number('itemsAvailable', null,  ['class' => 'form-control','placeholder'=>  trans("lang.product_items_avilable_placeholder"),'step'=>"any", 'min'=>"0"]) !!}
            <div class="form-text text-muted">
                {{ trans("lang.product_items_avilable_help") }}
            </div>
        </div>
    </div>
