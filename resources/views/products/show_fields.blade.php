...
<div class="form-group row col-6">
  {!! Form::label('items_available', 'Available Items :', ['class' => 'col-3 control-label text-right']) !!}
  <div class="col-9">
    <p>{!! $product->itemsAvailable !!}</p>
  </div>
</div>
<!-- Capacity Field -->
<div class="form-group row col-6">
...
<!-- Brand Id Field -->
<div class="form-group row col-6">
  {!! Form::label('brand_id', 'Brand Id:', ['class' => 'col-3 control-label text-right']) !!}
  <div class="col-9">
