                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('stores*') ? 'active' : '' }}"
                       href="{!! route('stores.index') !!}">@if($icons)
                            <i class="nav-icon fa fa-reorder"></i>@endif<p>{{trans('lang.store_plural')}}</p></a>
                </li>
            @endcan
            @can('galleries.index')
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('optionGroups*') ? 'active' : '' }}"
                       href="{!! route('optionGroups.index') !!}">@if($icons)<i
                                class="nav-icon fa fa-plus-square"></i>@endif
...
@can('medias')
    <li class="nav-item">
        <a class="nav-link {{ Request::is('medias*') ? 'active' : '' }}" href="{!! url('medias') !!}">@if($icons)<i
                    class="nav-icon fa fa-picture-o"></i>@endif
            ...
            @can('drivers.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('drivers*') ? 'active' : '' }}"
                       href="{!! route('drivers.index') !!}">@if($icons)<i class="nav-icon fa fa-car"></i>@endif
            ...
            @can('earnings.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('earnings*') ? 'active' : '' }}"
                       href="{!! route('earnings.index') !!}">@if($icons)<i class="nav-icon fa fa-money"></i>@endif
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('driversPayouts*') ? 'active' : '' }}"
                       href="{!! route('driversPayouts.index') !!}">@if($icons)<i
                                class="nav-icon fa fa-dollar"></i>@endif<p>{{trans('lang.drivers_payout_plural')}}</p>
                    </a>
                </li>
            @endcan
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('storesPayouts*') ? 'active' : '' }}"
                       href="{!! route('storesPayouts.index') !!}">@if($icons)<i
                                class="nav-icon fa fa-dollar"></i>@endif<p>{{trans('lang.stores_payout_plural')}}</p>
                    </a>
                </li>
            @endcan
        ...
        <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('sliders*') ? 'active' : '' }}" href="{!! route('sliders.index') !!}">@if($icons)<i
                            class="nav-icon fa fa-pencil"></i>@endif<p>{{trans('lang.slider_plural')}}</p></a>
            </li>
            ...
            @can('currencies.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('currencies*') ? 'active' : '' }}"
                       href="{!! route('currencies.index') !!}">@if($icons)<i class="nav-icon fa fa-dollar"></i>@endif
