...
private $storeRepository;
    ...
    public function __construct(EarningRepository $earningRepo, CustomFieldRepository $customFieldRepo , StoreRepository $storeRepo, OrderRepository $orderRepository)
    {
        parent::__construct();
    ...
    public function create()
    {
        ...
        foreach ($stores as $store){
            $storeId = $store->id;
            $this->earningRepository->firstOrCreate(['store_id'=>$storeId])->first();
        }
    ...
    public function edit($id)
    {
        ...
        return view('earnings.edit')->with('earning', $earning)->with("customFields", isset($html) ? $html : false)->with("store",$store);
    }
